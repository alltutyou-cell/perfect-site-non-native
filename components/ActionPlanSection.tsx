...
const ActionPlanSection: React.FC = () => {
  ...
  return (
    <section className="py-24">
      <div className="mb-16">
        <h2 className="text-6xl md:text-8xl font-dela tracking-tighter leading-none mb-4">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        {steps.map((step, i) => (
          <div key={i} className="group relative bg-white border-4 border-black p-8 card-shadow hover:bg-[#FF4A22] hover:text-white transition-all">
            <div className="font-dela text-4xl mb-4 opacity-20 group-hover:opacity-100">{step.week}</div>
            <h3 className="font-dela text-xl mb-4 leading-tight">{step.title}</h3>
